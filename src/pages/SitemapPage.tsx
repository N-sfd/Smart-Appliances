...
const SITEMAP_SECTIONS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Common Small Home Projects a Handyman Can Help With', path: '/resources/handyman-small-home-projects' },
      { label: 'Furniture Assembly Tips Before Booking Help', path: '/resources/furniture-assembly-tips' },
      { label: 'Wall Hanging Guide: Pictures, Shelves, Mirrors, and Décor', path: '/resources/wall-hanging-guide' },
      { label: 'Drywall Repair Basics: Small Holes, Cracks, and Patches', path: '/resources/drywall-repair-basics' },
      { label: 'TV Mounting Cost Guide: What Affects the Final Price?', path: '/resources/tv-mounting-cost-guide' },
      { label: 'TV Wall Mounting Checklist Before Your Appointment', path: '/resources/tv-wall-mounting-checklist' },
      { label: 'Wire Concealment for TV Mounting: What to Know', path: '/resources/wire-concealment-guide' },
      { label: 'Phone Screen Repair Guide: Cracks, Touch Issues, and Display Problems', path: '/resources/phone-screen-repair-guide' },
      { label: 'Signs Your Phone Battery May Need Replacement', path: '/resources/phone-battery-replacement-signs' },
      { label: 'Charging Port Problems: Cable, Dirt, or Repair Needed?', path: '/resources/charging-port-repair-guide' },
      { label: 'Should You Repair or Replace Your Phone?', path: '/resources/phone-repair-or-replace' },
    ],
  },
  {
    title: 'Account & Legal',
