...
export const homeAppliancesPageConfig: ServiceCategoryPageConfig = {
  ...
  hero: {
    ...
    image: `${BASE}/home-appliances/hero.webp`,
    primaryCta: 'Schedule Appliance Service',
  ...
  bottomCta: {
    ...
    primaryLabel: 'Schedule Appliance Service',
...
export const plumbingPageConfig: ServiceCategoryPageConfig = {
  ...
  hero: {
    ...
    image: `${BASE}/plumbing-service.webp`,
...
export const smartHomePageConfig: ServiceCategoryPageConfig = {
  ...
  hero: {
    ...
    primaryCta: 'Schedule Smart Home Service',
  ...
  bottomCta: {
    ...
    primaryLabel: 'Schedule Smart Home Service',
...
export const electricalPageConfig: ServiceCategoryPageConfig = {
  ...
  hero: {
    ...
    image: `${BASE}/electrical/hero.webp`,
    imagePosition: '28% center',
    primaryCta: 'Schedule Electrical Service',
  ...
  bottomCta: {
    ...
    primaryLabel: 'Schedule Electrical Service',
...
export const SERVICE_CATEGORY_PAGE_MAP: Record<string, ServiceCategoryPageConfig> = {
  ...
  'tv-mounting': {
    ...
    hero: {
      ...
      primaryCta: 'Schedule TV Mounting',
      secondaryCta: 'Ask About Installation',
      layout: 'split',
    ...
    faqs: [
      ...
      { question: 'What wall types do you support?', answer: 'We mount on drywall, studs, brick, and concrete when the right hardware is used for your wall type.' },
      { question: 'Can you install a soundbar too?', answer: 'Yes. Soundbar and media-device setup can be added when you schedule your TV mounting appointment.' },
      { question: 'Is same-day mounting available?', answer: 'Same-day appointments are often available depending on your ZIP code and technician schedule.' },
    ],
    bottomCta: {
  ...
  'phone-repair': {
    ...
    hero: {
      ...
      primaryCta: 'Schedule Phone Repair',
    ...
    faqs: [
      ...
      { question: 'Which phone brands do you service?', answer: 'We commonly service Apple, Samsung, Google, Motorola, OnePlus, Nokia, LG, Sony, and similar devices.' },
      { question: 'How long does a typical repair take?', answer: 'Many screen and battery repairs can be completed the same day once parts are confirmed. Your technician will set expectations after diagnosis.' },
      { question: 'Should I back up my phone first?', answer: 'Yes. Back up your device before service whenever possible so your data stays protected.' },
    ],
    bottomCta: {
      title: 'Need phone repair help?',
      subtitle: 'Tell us your device model and issue to get started.',
      primaryLabel: 'Schedule Phone Repair',
      secondaryLabel: 'Contact Us',
    },
    desktopIconColumns: 3,
    cardHoverLift: true,
  ...
  handyman: {
    ...
    hero: {
      ...
      primaryCta: 'Schedule Handyman Service',
    ...
    faqs: [
      ...
      { question: 'Can you assemble furniture?', answer: 'Yes. We assemble furniture from popular retailers and can hang shelves, mounts, and fixtures when requested.' },
      { question: 'Do you handle small drywall repairs?', answer: 'Yes. Minor drywall patching and touch-up work are common handyman requests.' },
      { question: 'How do I describe my project?', answer: 'Share photos, approximate dimensions, and access notes when booking so we can match the right technician.' },
    ],
    bottomCta: {
      title: 'Need a handyman?',
      subtitle: 'Describe your project and pick a convenient time.',
      primaryLabel: 'Schedule Handyman Service',
      secondaryLabel: 'Contact Us',
    },
    desktopIconColumns: 3,
    cardHoverLift: true,
