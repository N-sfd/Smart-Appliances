...
export const EXPERTS: Expert[] = [
  {
    ...
    initials: 'SA',
    imageUrl: '/images/services/appliances/technician-default.webp',
    avatarUrl: '/images/services/appliances/technician-default.webp',
    rating: 4.9,
    reviewCount: 128,
    jobsCompleted: '750+',
  ...
  },
  {
    ...
    category: 'HVAC',
    initials: 'HC',
    imageUrl: '/images/services/hvac/emergency-hvac-service.png',
    avatarUrl: '/images/services/hvac/emergency-hvac-service.png',
    rating: 4.8,
    reviewCount: 74,
    jobsCompleted: '320+',
